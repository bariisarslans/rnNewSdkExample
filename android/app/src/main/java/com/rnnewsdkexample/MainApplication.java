...
import com.rnnewsdkexample.newarchitecture.MainApplicationReactNativeHost;
    ...
    initializeFlipper(this, getReactNativeHost().getReactInstanceManager());
     RelatedDigitalManager rdManager = RelatedDigitalManager.Companion.getSharedInstance();
      ...
      rdManager.initRelatedDigital(getApplicationContext(),
        "676D325830564761676D453D", // your organizationId
        "356467332F6533766975593D", // your profileId
        "visistore", // your dataSource
        "RnNewPushSdk", // your firebase app alias defined in RMC panel
        "RnNewPushSdk", // your huawei app alias defined in RMC panel
        true, // set true to enable push notifications
        false, // set true to enable geofence
              R.mipmap.ic_launcher, // notificationSmallIcon
              R.mipmap.ic_launcher, // notificationSmallIconDarkMode
        true, // isNotificationLargeIcon
        R.mipmap.ic_launcher, // notificationLargeIcon
        R.mipmap.ic_launcher, // notificationLargeIconDarkMode
        "com.rnnewsdkexample.MainActivity", // notificationPushIntent
        "RelatedDigital Channel", // notificationChannelName
        "#d1dbbd", // notificationColor
        RDNotificationPriority.HIGH // notificationPriority
      );
  }
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("com.rnnewsdkexample.ReactNativeFlipper");
        aClass
